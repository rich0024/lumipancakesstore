  ...
  if (!fs.existsSync(DB_FILE)) {
    const initialData = [
      ...
      },
      {
        ...
        price: 18.99,
        image: '/images/newjeans-hanni.jpg',
        group: 'NewJeans',
        member: 'Hanni',
        album: 'Get Up',
        set: 'Get Up Limited',
      ...
      },
      {
        ...
        price: 14.99,
        image: '/images/lesserafim-chaewon.jpg',
        group: 'LE SSERAFIM',
        member: 'Chaewon',
        album: 'UNFORGIVEN',
      ...
      },
      {
        ...
        price: 13.99,
        image: '/images/straykids-felix.jpg',
        group: 'Stray Kids',
        member: 'Felix',
        album: '5-STAR',
        set: '5-STAR Standard',
